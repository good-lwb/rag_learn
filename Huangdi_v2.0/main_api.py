...
from langchain_community.retrievers import BM25Retriever   # Bm25必须在这里导入，该死的ai告诉我在langchain害得我找了一下午bug
from langchain.chains.question_answering import load_qa_chain
from transformers import AutoModelForCausalLM, AutoTokenizer
from langchain_community.embeddings import HuggingFaceBgeEmbeddings

"""
这份代码使用阿里云百炼的api作为llm

首先需要在终端执行: export DASHSCOPE_API_KEY='sk-xxxx'
配置你的api(api的获取自己去阿里云平台操作一下就行,不再赘述)
"""
...
def generation_res(question: str, docs, chatLLM: Any):  
    """
    根据召回的文档生成回复
